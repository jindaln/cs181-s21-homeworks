...
$$ L(W) = {1 \over 2} \sum_{i=1}^N (y_i - f(x_i))^2$$
$$ = {1 \over 2} \sum_{i=1}^N (y_i - {\sum_{n \neq i} K(x_n, x_i) y_n \over \sum_{n \neq i} K(x_n, x_i) } )^2$$

$$ = {1 \over 2} \sum_{i=1}^N (y_i - {\sum_{n \neq i} e^{-((x_n - x_i)^T W(x_n - x_i)) y_n \over \sum_{n \neq i} e^{-((x_n - x_i)^T W(x_n - x_i))} )^2$$
